# Waypoints Collection Autocomplete Map

This example demonstrates how to use Geoapify APIs with Leaflet and Geoapify Geocoder Autocomplete.
...
- [Routing API](https://www.geoapify.com/routing-api/)
